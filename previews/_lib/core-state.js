...
(function() {
  ...
  const STAT_DEFS = [
    { key: 'strength', page: 'strength.html', model: 'body',      name: 'Strength', sub: 'Body',      color: '#FF6B6B', emoji: '⚔️', blurb: 'Train your body and push your physical limits.', tip: 'Log workouts and physical quests to build Strength.', icon: '<path d="M6 7v10M3 9.5v5M18 7v10M21 9.5v5M6 12h12"/>' },
